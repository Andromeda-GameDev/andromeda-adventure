...
<div class="card-content">
    ...
    <div class="card-body">
        <div class="apple-side">
            ...
            <A href={guideLinks('apple')} class="text-blue-600 hover:text-blue-400 mt-6" target="_blank">Guia de instalación</A>
        ...
        <div class="android-side">
            ...
            <A href={guideLinks('android')} class="text-blue-600 hover:text-blue-400 mt-6" target="_blank">Guia de instalación</A>
