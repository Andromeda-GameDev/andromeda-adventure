<script lang="ts">
    ...
    import { FetchedData } from '../stores/professorData'
    ...
    function apkLink(){
        if(media && media.downloads && media.downloads.length > 0 && media.downloads[0].url){
            console.log(media.downloads[0].url);
...
<div class="card-content">
    <div class="class-header">
        ...
        <Button class="hover:bg-purple-100 text-purple-500 font-bold px-3 bg-opacity-0"
            target="_blank"
            on:click={() =>
                downloadImage()
            }
    ...
    <div class="card-body">
        ...
        <div class="android-side">
            ...
            <Button class="bg-purple-600 hover:bg-purple-400 text-white font-bold px-3 mt-10" target="_blank"
                href="https://drive.google.com/file/d/1Twfek-GvkisX6KydW5I11XWPlXEvkF2C/view?usp=drive_link"
            >
                Descargar
                <svelte:component this={ArrowDownToBracketOutline} class="ml-5" size="md"/>
            </Button>
