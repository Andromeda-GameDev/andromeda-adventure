...
const css = {
  code: ".stats-container.svelte-724ivg{display:flex;flex-direction:column;width:100%;height:100%}.stats-container-header.svelte-724ivg{display:flex;flex-direction:row;align-items:center;width:100%;height:10%;padding-left:3rem;padding-right:3rem;margin-top:1rem}.search-container.svelte-724ivg{display:flex;align-items:center;width:40%;height:100%}.filter-container.svelte-724ivg{display:flex;flex-direction:row;justify-content:flex-end;align-items:center;width:50%;gap:1rem}.table-container.svelte-724ivg{width:100%;height:100%;padding-left:3rem;padding-right:3rem}.footer-container.svelte-724ivg{display:flex;justify-content:space-between;align-items:center;width:100%;padding:1rem 0;flex-wrap:wrap;padding-top:2rem}.pagination-container.svelte-724ivg{display:flex;justify-content:center;align-items:center;gap:1rem;padding-right:1rem}.pages-select-conatiner.svelte-724ivg{width:6%}",
  map: null
};
const Page = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  do {
    ...
    selectedLevel = "1";
    $$rendered = `<div class="stats-container svelte-724ivg"><div class="stats-container-header svelte-724ivg"><div class="search-container svelte-724ivg">${validate_component(TableSearch, "TableSearch").$$render(
      $$result,
      {
      ...
      {}
    )}</div> <div class="flex-grow"></div> <div class="filter-container svelte-724ivg">${validate_component(Select, "Select").$$render(
      $$result,
      {
        id: "groupSelect",
        name: "groupSelect",
    ...
    )}</div></div> <div class="table-container svelte-724ivg">${validate_component(Table, "Table").$$render(
      $$result,
      {
        hoverable: true,
        striped: true,
    ...
    )} <div class="footer-container svelte-724ivg"><caption class="text-md font-semibold text-black">Estudiantes: ${escape(filteredStudents.length)}</caption> <div class="pagination-container svelte-724ivg"><button>${validate_component(ArrowLeftOutline, "ArrowLeftOutline").$$render($$result, {}, {}, {})}</button> <div>Página ${escape(currentPage)} / ${escape(Math.ceil(filteredStudents.length / parseInt(itemsPerPage)))}</div> <button>${validate_component(ArrowRightOutline, "ArrowRightOutline").$$render($$result, {}, {}, {})}</button></div> <div class="pages-select-conatiner svelte-724ivg">${validate_component(Select, "Select").$$render(
      $$result,
      {
