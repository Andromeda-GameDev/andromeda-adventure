...
import { S as Students } from "../../../../chunks/adminData.js";
const css = {
...
const Layout = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  return `<div class="main-container svelte-t11qlq"><div class="bread-crumb-container svelte-t11qlq">${validate_component(Breadcrumb, "Breadcrumb").$$render(
    ...
    {
      default: () => {
        return `${validate_component(BreadcrumbItem, "BreadcrumbItem").$$render($$result, { href: "/admin/statistics", home: true }, {}, {
          icon: () => {
        ...
        })} ${student && activeUrl !== "/admin/statistics" && activeUrl !== "/admin/statistics/" ? `${validate_component(BreadcrumbItem, "BreadcrumbItem").$$render($$result, {}, {}, {
          default: () => {
